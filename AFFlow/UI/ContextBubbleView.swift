...
/// The AF Flow mark used inside the context bubble.
///
/// This drew the upstream project's chilli character, and fell back to a chilli
/// emoji when the asset was missing, so both branches carried the old brand. The
/// asset is gone and the glyph now matches the one the meeting window uses.
private struct AFFlowMark: View {

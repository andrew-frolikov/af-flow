...
private let calendarLog = Logger(subsystem: "com.frolikov.afflow", category: "calendar")
    ...
    <html>
      ...
      <body>
        <main>
          ...
          <a href="com.frolikov.afflow://calendar-connected">Return to AF Flow</a>
        </main>
        <script>
          setTimeout(function () {
            window.location.href = "com.frolikov.afflow://calendar-connected";
          }, 700);
        </script>
      </body>
    </html>

...
///
/// Run with: `xcodebuild test -scheme AFFlow -testPlan CleanupPromptEvals`
/// Or individually: `xcodebuild test -scheme AFFlow -only-testing:AFFlowTests/CleanupPromptEvalTests`

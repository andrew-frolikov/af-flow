...
Source of truth for the brand: the author's private brand canon, which is not part of this repository (the canon). This document applies the canon to a native macOS app and decides everything the canon does not cover. Where it adds to the canon, section 9 contains the paste-ready text.

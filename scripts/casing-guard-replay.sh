...
ARCHIVE="${AF_FLOW_LAB_ARCHIVE:-$HOME/Library/Containers/com.frolikov.afflow/Data/Library/Application Support/AFFlow/transcription-lab/transcription-lab-index.jsonl}"
if [ ! -f "$ARCHIVE" ]; then

...
set -e
APP="$HOME/Library/Containers/com.frolikov.afflow/Data/Library/Application Support/AFFlow"
TH="$HOME/Library/Containers/com.frolikov.afflow.testhost/Data/Library/Application Support/AFFlow"

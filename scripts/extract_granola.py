...
Writes: ~/Documents/AF Flow Meetings/{date}/{slug}.md
...
def main():
    ...
    # Use AF Flow meetings directory if configured, else default
    output_base = os.path.expanduser('~/Documents/AF Flow Meetings')
    if len(sys.argv) > 1:

...
RUNNER_ENV=()
for name in AF_FLOW_FIXTURES AF_FLOW_OUTPUT AF_FLOW_MODELS AF_FLOW_ALLOW_MODEL_DOWNLOAD AF_FLOW_PREFETCH_MODEL AF_FLOW_MEETING_BAKEOFF AF_FLOW_SUMMARY_EVALS AF_FLOW_MEETING_NOTES AF_FLOW_SUMMARY_EVAL_MODEL AF_FLOW_SUMMARY_EVAL_PROMPT AF_FLOW_SUMMARY_EVAL_MAX_CHARS; do
    value="${!name:-}"
